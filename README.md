...
Chat SDK adapter for Velt: build bots that read, reply, mention, and start threads
in **[Velt](https://velt.dev) comment threads** across documents, rich-text editors,
...
single message; list a document's threads and start new ones; mention and tag
users; read attachments; and act on inbound mentions and reactions. See the
